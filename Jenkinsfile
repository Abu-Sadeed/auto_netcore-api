    ...
    stages {
        ...
        stage('Restart') {
            steps {
                script {
                    if (env.BRANCH_NAME == 'master') {
                        sh "ssh sadeed@localhost 'sudo /home/sadeed/workspace/pracs/autoShell/auto_netcore-api/svcscripts/svcOne.sh /home/sadeed/workspace/pracs/autoShell/auto_netcore-api/svcscripts/jsonOne.json'"
                        //sh "sudo systemctl restart netcore-api_publish.service"
                    } 
                    if (env.BRANCH_NAME == 'dev') {
                        sh "ssh sadeed@localhost 'sudo /home/sadeed/workspace/pracs/autoShell/auto_netcore-api/svcscripts/svcOne.sh /home/sadeed/workspace/pracs/autoShell/auto_netcore-api/svcscripts/jsonTwo.json'"
